...
# Ejecutar los siguiente comandos (Mencionar los de GPT).
#Xorg:0 -configure  # Esto va a crear un fichero xorg.conf.new en $HOME.
# Hay que copiarlo y mandarlo a este path:
...
# Ejecutar: sudo systemctl enable lightdm
